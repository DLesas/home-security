 ...
 */
export async function checkSensorState(previousState: doorSensor, state: "open" | "closed" | "unknown") {
 ...
 */
export async function changeSensorStatus(sensors: doorSensor[], armed: boolean) {
	const savePromises = [];
